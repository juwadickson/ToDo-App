    ...
    <header>
      ...
      <section>
        <div class="nav" id="nav">
          ...
          <a href="displayToDoChecked.php"  class="active">checked Todo (<?php include('../server/countCheckedTodo.php'); ?>)</a>
          <a href="displayToDoUnchecked.php">Unchecked Todo (<?php include('../server/countUncheckedTodo.php'); ?>)</a>
        </div>
        <div class="nav-content">
          ...
          <div class="events">
            <?php 
              ...
              $sql2 = "SELECT * FROM todolist WHERE user_id='$id' AND checked = 1";
              ...
              while($rows = mysqli_fetch_assoc($result2)){
                ...
                echo '
                <div style="background-color:orange">'.$event.'<span><a href="../server/deleteTodo.php?eventId='.$event_id.'"><i class="fa fa-times"></i></a></span></div>
              ';
              }
